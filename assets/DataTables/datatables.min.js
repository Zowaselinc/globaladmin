...
!(function (n) {
		...
		for (var e, n, a, r, o, i, l, s = t.aoColumns, u = t.aoData, c = C.ext.type.detect, f = 0, d = s.length; f < d; f++)
			if (((l = []), !(o = s[f]).sType && o._sManualType)) o.sType = o._sManualType;
				...
				for (e = 0, n = c.length; e < n; e++) {
					for (
						a = 0, r = u.length;
						a < r && (l[a] === N && (l[a] = S(t, a, f, "type")), (i = c[e](l[a], t)) || e === c.length - 1) && ("html" !== i || h(l[a]));
						a++
					);
					if (i) {
						o.sType = i;
	...
	function y(t, e) {
		(n = "ssp" == E((s = t))),
			(l = s.iInitDisplayStart) !== N && -1 !== l && ((s._iDisplayStart = !n && l >= s.fnRecordsDisplay() ? 0 : l), (s.iInitDisplayStart = -1));
			...
			if (!(o = t.aoData[s])._aFilterData) {
				for (a = [], e = 0, n = i.length; e < n; e++)
					i[e].bSearchable
						...
						: (r = ""),
						r.indexOf && -1 !== r.indexOf("&") && ((Mt.innerHTML = r), (r = kt ? Mt.textContent : Mt.innerText)),
	...
	function Qt(n) {
		...
		n.scrollBarVis !== R && n.scrollBarVis !== N
			...
			: ((n.scrollBarVis = R),
			  ...
			  "" === s
					? ((C.width = "100%"),
					  x && (D.find("tbody").height() > g.offsetHeight || "scroll" == b.css("overflow-y")) && (C.width = k(D.outerWidth() - l)),
					  (f = D.outerWidth()))
			  ...
			  Math.round(D.outerWidth()) < Math.round(f)
					? ((o = g.scrollHeight > g.offsetHeight || "scroll" == b.css("overflow-y") ? f + l : f),
					  x && (g.scrollHeight > g.offsetHeight || "scroll" == b.css("overflow-y")) && (C.width = k(o - l)),
	...
	function ee(t) {
		...
		if (g || (!h && !l && !i && s == T(t) && s == c.length))
			...
			for (
				...
				(e = r[u[D]]),
					(c[D].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? k(e.sWidthOrig) : ""),
	...
	function _e(t, e, n, a, r) {
		for (
			var o, i, l, s, u = [], c = typeof e, f = 0, d = (e = e && "string" != c && "function" != c && e.length !== N ? e : [e]).length;
			f < d;
			f++
		)
		...
		He =
			...
			(C.defaults = {
				...
				fnStateLoadCallback: function (t) {
					try {
						return JSON.parse(
							(-1 === t.iStateDuration ? sessionStorage : localStorage).getItem("DataTables_" + t.sInstance + "_" + location.pathname)
						);
					} catch (t) {
						return {};
					}
...
!(function (t) {
	"function" == typeof define && define.amd
		...
		? (module.exports = function (e, n) {
				return (
					(e = e || window),
					(n = n || ("undefined" != typeof window ? require("jquery") : require("jquery")(e))).fn.dataTable ||
