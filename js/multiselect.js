				...
				if (i) {
					...
					document.body.appendChild(o),
						requestAnimationFrame(function () {
							i && o.offsetWidth !== e.offsetWidth && (n = o.offsetWidth + 4),
			...
			var a = {
				...
				item: function (e, t, i) {
					var n,
						...
						u = (0, o.default)(
							e.item,
							(s((n = {}), e.highlightedState, t.highlighted),
							s(n, e.itemSelectable, !t.highlighted),
							s(n, e.placeholder, t.placeholder),
							n)
						);
					return i
						? ((u = (0, o.default)(
								e.item,
								(s((a = {}), e.highlightedState, t.highlighted),
								s(a, e.itemSelectable, !t.disabled),
								s(a, e.placeholder, t.placeholder),
								a)
						  )),
						  (0, r.strToEl)(
								'\n        <div\n          class="'
				...
				choice: function (e, t, i) {
					var n,
						...
						c = (0, o.default)(
							e.item,
							e.itemChoice,
							(s((n = {}), e.itemDisabled, t.disabled), s(n, e.itemSelectable, !t.disabled), s(n, e.placeholder, t.placeholder), n)
						);
					return (0, r.strToEl)(
						'\n      <div\n        class="'
							.concat(c, '"\n        data-select-text="')
				...
				notice: function (e, t) {
					var i,
						...
						a = (0, o.default)(
							e.item,
							e.itemChoice,
							(s((i = {}), e.noResults, "no-results" === n), s(i, e.noChoices, "no-choices" === n), i)
						);
					return (0, r.strToEl)('\n      <div class="'.concat(a, '">\n        ').concat(t, "\n      </div>\n    "));
				},
				option: function (e) {
				...
				try {
					!(function (e) {
						Object.keys(e).forEach(function (t) {
							...
							if (
								void 0 ===
								i(void 0, { type: "@@redux/PROBE_UNKNOWN_ACTION_" + Math.random().toString(36).substring(7).split("").join(".") })
							)
								throw new Error(
									'Reducer "' +
										t +
				...
				function e() {
					...
					return l
						? ((this._isTextElement = "text" === l.type),
						  ...
						  this._isTextElement
								? (this.passedElement = new s.WrappedInput({
										element: l,
										classNames: this.config.classNames,
										delimiter: this.config.delimiter,
								  }))
								: this._isSelectElement &&
								  (this.passedElement = new s.WrappedSelect({ element: l, classNames: this.config.classNames })),
						  this.passedElement
								? (!0 === this.config.shouldSortItems &&
								  ...
								  "active" === this.passedElement.element.getAttribute("data-choice") &&
				...
				return (
					...
					(i = [
								...
								return this.dropdown.isActive
									...
									: (requestAnimationFrame(function () {
											t.dropdown.show(),
												...
												t.passedElement.triggerEvent(a.EVENTS.showDropdown, {});
									  }),
									  this);
							},
						},
								...
								return this.dropdown.isActive
									? (requestAnimationFrame(function () {
											t.dropdown.hide(),
												...
												t.passedElement.triggerEvent(a.EVENTS.hideDropdown, {});
									  }),
									  this)
									: this;
							},
						...
						},
						{
							...
							value: function () {
								...
								return (
									...
									!this._isTextElement &&
										this._canSearch &&
										((this._isSearching = !1), this._store.dispatch((0, l.activateChoices)(!0))),
									this
								);
							},
						},
						...
						},
						{
							...
							value: function () {
								...
								if (o.childNodes && o.childNodes.length > 0) {
									...
									var c, l;
									this._isSearching
										? ((l = (0, p.isType)("Function", this.config.noResultsText)
												? this.config.noResultsText()
												: this.config.noResultsText),
										  (c = this._getTemplate("notice", l, "no-results")))
										: ((l = (0, p.isType)("Function", this.config.noChoicesText)
						...
						},
						{
							...
							value: function (e, t) {
								if (e && t) {
									...
									if (
										((n.keyCode = o),
										this.passedElement.triggerEvent(a.EVENTS.choice, { choice: n }),
							...
							value: function (e, t) {
								...
								if (!this._isSelectOneElement) {
									...
									this.config.maxItemCount > 0 &&
										...
										((i = !1),
										(n = (0, p.isType)("Function", this.config.maxItemText)
										...
										!this.config.duplicateItemsAllowed &&
											...
											i &&
											((i = !1),
											(n = (0, p.isType)("Function", this.config.uniqueItemText)
										...
										this._isTextElement &&
											...
											((i = !1),
											(n = (0, p.isType)("Function", this.config.customAddItemText)
						...
						},
						{
							...
							value: function (e) {
								...
								return (
									...
									(this._highlightPosition = 0),
									(this._isSearching = !0),
									this._store.dispatch((0, l.filterChoices)(c)),
									c.length
								);
							},
						},
							...
							value: function (e) {
								...
								if (t === this.input.element) {
									...
									if (this._isTextElement) {
										...
										h && d
											? ((this._isSearching = !1), this._store.dispatch((0, l.activateChoices)(!0)))
											: f && this._handleSearch(this.input.value);
									}
									this._canSearch = this.config.searchEnabled;
								}
							},
						...
						},
						{
							...
							value: function (e) {
								...
								if (this._isTextElement && i.value) {
									...
									this._canAddItem(n, c).response &&
										(this.hideDropdown(!0), this._addItem({ value: c }), this._triggerChange(c), this.clearInput());
								}
							...
							value: function (e) {
								...
								if (i || this._isSelectOneElement) {
									...
									if (o || n === c || n === s)
										l =
											u > 0
												? Array.from(this.dropdown.element.querySelectorAll("[data-choice-selectable]")).pop()
										...
										l = h
											? (0, p.getAdjacentEl)(h, "[data-choice-selectable]", u)
											: this.dropdown.element.querySelector("[data-choice-selectable]");
									}
									l &&
										((0, p.isScrolledIntoView)(l, this.choiceList.element, u) || this.choiceList.scrollToChoice(l, u),
						...
						},
						{
							...
							value: function (e) {
								var t = e.target,
									i = e.shiftKey;
								if (
									(this.choiceList.element.contains(t) && (0, p.isIE11)() && (this._isScrollingOnIe = !0),
									this.containerOuter.element.contains(t) && t !== this.input.element)
								) {
									...
									r ? this._handleButtonAction(n, r) : s ? this._handleItemAction(n, s, o) : a && this._handleChoiceAction(n, a),
										e.preventDefault();
								}
							},
						},
						{
							...
							value: function (e) {
								var t = e.target;
								(t === this.dropdown || this.dropdown.element.contains(t)) &&
						...
						},
						{
							...
							value: function (e) {
								...
								this.containerOuter.element.contains(t)
									...
									: (this._store.highlightedActiveItems && this.unhighlightAll(),
							...
							value: function (e) {
								...
								if (this.containerOuter.element.contains(i) && !this._isScrollingOnIe) {
									...
									({
										text: function () {
											i === t.input.element &&
												(t.containerOuter.removeFocusState(), n && t.unhighlightAll(), t.hideDropdown(!0));
										},
										"select-one": function () {
										...
										"select-multiple": function () {
											i === t.input.element &&
												(t.containerOuter.removeFocusState(), t.hideDropdown(!0), n && t.unhighlightAll());
										},
									}[this.passedElement.element.type]());
						...
						},
						{
							...
							value: function () {
								...
								if (i.length) {
									var n = t;
									Array.from(this.dropdown.element.querySelectorAll(".".concat(this.config.classNames.highlightedState))).forEach(
										function (t) {
										...
										n
											...
											: (n = i.length > this._highlightPosition ? i[this._highlightPosition] : i[i.length - 1]) || (n = i[0]),
						...
						},
						{
							...
							value: function (e) {
								...
								return (
									...
									this.passedElement.triggerEvent(a.EVENTS.addItem, {
										id: O,
										value: g,
										label: E,
										customProperties: y,
						...
						},
						{
							...
							value: function () {
								...
								e && (0, p.isType)("Function", e) && (t = e.call(this, p.strToEl)),
									(this.config.templates = (0, o.default)(c.TEMPLATES, t));
							},
						},
						{
							key: "_createElements",
						...
						/*! no static exports found */ function (e, t, i) {
							...
							e.exports = function (e, t, i, r) {
								...
								for (var C = [], T = 1, w = b + g, k = 1 << (b - 1), A = 0; A < b; A += 1) {
									for (var L = 0, x = w; L < x; ) {
										n(t, { errors: A, currentLocation: m + x, expectedLocation: m, distance: l }) <= _ ? (L = x) : (w = x),
											(x = Math.floor((w - L) / 2 + L));
									}
									w = x;
												...
												value: function () {
													...
													for (var a = {}, c = 0, l = i.length; c < l; c += 1)
														for (var u = i[c], h = 0, d = this.options.keys.length; h < d; h += 1) {
															...
															this._analyze(
																{ key: f, value: this.options.getFn(u, f), record: u, index: c },
																{ resultMap: n, results: o, tokenSearchers: e, fullSearcher: t }
															);
														}
												...
												value: function (e, t) {
													...
													if (null != r) {
														...
														if ("string" == typeof r) {
															...
															var b = d.search(r);
															if (
																(this._log('Full text: "'.concat(r, '", score: ').concat(b.score)),
																this.options.tokenize)
															) {
																for (
																	var E = r.split(this.options.tokenSeparator), S = [], I = 0;
																	I < u.length;
																	I += 1
																) {
																	var O = u[I];
																	...
																	for (var C = !1, T = 0; T < E.length; T += 1) {
																		var w = E[T],
																			...
																			A = {};
																		k.isMatch
																			? ((A[w] = k.score), (g = !0), (C = !0), S.push(k.score))
																			: ((A[w] = 1), this.options.matchAllTokens || S.push(1)),
															...
															for (var M = 0, N = r.length; M < N; M += 1)
																this._analyze(
																	{ key: i, arrayIndex: M, value: r[M], record: s, index: c },
											...
											},
											{
												...
												value: function (e) {
													...
													for (var r = 0, s = e.length; r < s; r += 1) {
														var a = e[r];
														if (
															(this.options.id && (a.item = this.options.getFn(a.item, this.options.id)[0]), o.length)
														) {
